...
export const logsSchemaToolSchema: Tool = {
  ...
  description:
    "Get comprehensive schema information for Coralogix logs including available fields, search examples, and query syntax tips to help construct effective log queries.",
  inputSchema: {
    type: "object",
    properties: {
      includeExamples: {
        type: "boolean",
        default: true,
        description: "Include practical query examples for common use cases",
      },
      includeAdvanced: {
        type: "boolean",
        default: false,
        description:
          "Include advanced DataPrime operators and complex examples",
      },
    },
  },
};
